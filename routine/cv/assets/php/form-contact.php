...
//Recipients
$mail->setFrom('no-reply@mydomain.com', 'MESSAGE CV');  // which email will be sent from
$mail->addAddress('arthurlbc21@gmail.com', 'Company Name');  // who needs to send a letter

// Content
$mail->CharSet = 'UTF-8';
$mail->IsHTML(true);
$mail->Subject = 'CV';  // subject of the letter
$mail->Body = $body;
