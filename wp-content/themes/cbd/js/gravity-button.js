        ...
        element.addEventListener("click", function (e) {
            ...
            if (!container.classList.contains("active")) {
                ...
                if(!hsShadow.classList.contains("active")) {
                    ...
                    if (window.innerWidth > 992 && labelEl) labelEl.textContent = 'Fermer';
                }
                else {
                    if (window.innerWidth > 992 && labelEl) labelEl.textContent = 'Fermer';
                }
        ...
        el.addEventListener("click", function (e) {
            ...
            if (!isActive) {
                ...
                if (el.querySelector('.gravity-button-label')) {
                    el.querySelector('.gravity-button-label').textContent = 'Fermer';
                }
            } else {
                container.classList.remove('active');
                document.body.classList.remove('hubspot-open');
                document.body.style.overflow = '';
                el.querySelector('.gravity-button-label').textContent = 'Préparer un appel';
            }
            ...
            if (hubspotOverlay && container) {
                hubspotOverlay.addEventListener('click', function () {
                    ...
                    meetingElements.forEach(function (btn) {
                        ...
                        if (label) label.textContent = 'Préparer un appel';
                    });
                }, { once: true });
            }
        });
