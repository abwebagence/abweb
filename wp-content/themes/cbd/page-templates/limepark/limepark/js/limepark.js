document.addEventListener("DOMContentLoaded", function () {
  ...
  const bespokeWireframes = new Swiper(".bespoke-wireframes", {
    centeredSlides: true,
    initialSlide: 1,
    spaceBetween: 60,
    slidesPerView: 1.5,
  ...
  var video = document.getElementById("video-branch")
...
let searchBarTextString = "https://limepark.com/"
let textString = ""
...
const interactiveJS = () => {
  ...
  for (let i = 0; i < imageSliders.length; i++) {
    imageSliders[i].addEventListener("mouseenter", () => {
      gsap.to(imageSliders[i], {
        duration: 0.5,
        boxShadow: "0 0 0 0.5rem #002d28, 0 0 5rem 0.25rem #002d28",
        scale: 1.01,
      })
    })
  ...
  gsap.to(".marqueeSliderDivBanner", {
    scrollTrigger: {
      scroller: "#body-wrap",
      trigger: ".marqueeSliderDivBanner",
      start: () => window.innerHeight * 0 + " bottom",
      end: () => window.innerHeight * 0.8 + " top",
      scrub: 1,
    },
